                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto"> 
                                            <form class="row g-2">
                                                ...
                                                <div class="col-auto">
                                                  <a class="text-white" href="/add/add-salary.php"><button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addBoard"><i class="fa-solid fa-plus me-1"></i>Thêm danh mục miễn thuế cho nhân viên</button></a>
                                                </div><!--end col-->
                                            </form>    
                                        </div><!--end col-->
                                    </div><!--end row-->                                  
