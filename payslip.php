                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto"> 
                                            <form class="row g-2">
                                                ...
                                                <div class="col-auto">
                                                  <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addBoard"><i class="fa-solid fa-plus me-1"></i><a class="text-white" href="/add/add-payslip.php">Thêm phiếu lương</a></button>
                                                </div><!--end col-->
                                            </form>    
                                        </div><!--end col-->
                                    </div><!--end row-->                                  
