                ...
                <li class="dropdown">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-question" viewBox="0 0 16 16">
                     ...
                     <div class="dropdown-menu">
                         ...
                         <a class="dropdown-item" href="#">User Forum</a>
                         <a class="dropdown-item" href="#">Report an Issue</a>
                         <a class="dropdown-item" href="#">About</a>
                         <a class="dropdown-item" href="#">keyboard Shortcut</a>
                     </div>
                 ...
                 <li class="dropdown topbar-item">
                     ...
                     <div class="dropdown-menu dropdown-menu-end py-0">
                         ...
                         <a class="dropdown-item" href="pages-faq.php"><i class="las la-wallet fs-18 me-1 align-text-bottom"></i> Earning</a>
                         ...
                         <a class="dropdown-item" href="pages-profile.php"><i class="las la-lock fs-18 me-1 align-text-bottom"></i> Security</a>
